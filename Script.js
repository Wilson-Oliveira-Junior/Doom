...
function start() {
    global.w = Math.min(440, Math.round(window.innerWidth / scale));
    global.h = Math.min(50, Math.round(window.innerHeight / scale));
